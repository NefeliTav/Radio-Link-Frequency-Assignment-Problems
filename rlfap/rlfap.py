...
def timer(func):
    ...
    def _time_it(*args, **kwargs):
        ...
        try:
            ...
            print('Function "{name}" took {time} s.'.format(name=func.__name__, time=elapsed/1000))
    return _time_it
...
with open("ctr2-f24.txt") as f:
    ...
    for line in f:
        ...
        if data[0] in constr.keys():
            constr[data[0]].append(data)        #constr is a dict that contains all the constraints and their weights
        else:
            constr[data[0]] = [data]
